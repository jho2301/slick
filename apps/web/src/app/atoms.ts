...
import type { CommandEntry } from '../features/messages/commands.ts';
import type { HermesState } from '../features/hermes/hermes-store.ts';
import { modelFingerprint } from '../features/messages/sessions.ts';
