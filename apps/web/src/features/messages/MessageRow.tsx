...
import { isGrouped } from './grouping.ts';
import { readSections, SECTION_CARDS } from './response-sections.ts';
import { badgeLabel, messageBadge, visibleMetadata, type MessageBadge } from './sessions.ts';
import { hasThinking, readThinking } from '../thinking/thinking.ts';
import { streamingThinkKey } from '../../app/live.ts';
import { openThread } from '../../app/navigation.ts';
import { store } from '../../app/store.ts';
import type { Surface } from '../../app/types.ts';
import { ThinkingBox } from '../thinking/ThinkingBox.tsx';
