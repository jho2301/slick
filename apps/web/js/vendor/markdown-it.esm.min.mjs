...
function et(e) {
	...
	if (e.md.options.linkify) for (let n = 0, r = t.length; n < r; n++) {
		...
		for (let a = r.length - 1; a >= 0; a--) {
			...
			if (o.type === "html_inline" && (Qe(o.content) && i > 0 && i--, $e(o.content) && i++), !(i > 0) && o.type === "text" && e.md.linkify.test(o.content)) {
...
var on = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/, sn = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function cn(e, t) {
	let n = e.pos;
...
function fn(e, t) {
	...
	if (i !== 33 && i !== 63 && i !== 47 && !dn(i)) return !1;
	let a = e.src.slice(r).match(Pt);
	if (!a) return !1;
	if (!t) {
		let t = e.push("html_inline", "", 0);
		t.content = a[0], ln(t.content) && e.linkLevel++, un(t.content) && e.linkLevel--;
	}
	return e.pos += a[0].length, !0;
}
//#endregion
//#region src/rules_inline/entity.ts
var pn = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, mn = /^&([a-z][a-z0-9]{1,31});/i;
function hn(e, t) {
	let n = e.pos, r = e.posMax;
	if (e.src.charCodeAt(n) !== 38 || n + 1 >= r) return !1;
	if (e.src.charCodeAt(n + 1) === 35) {
		let r = e.src.slice(n).match(pn);
		if (r) {
			if (!t) {
...
var q = [
	...
	["balance_pairs", _n],
	["strikethrough", Qt.postProcess],
	["emphasis", nn.postProcess],
	["fragments_join", vn]
], bn = class {
	constructor() {
		T(this, "ruler", new z()), T(this, "ruler2", new z()), T(this, "State", Vt);
		for (let e = 0; e < q.length; e++) this.ruler.push(q[e][0], q[e][1]);
		for (let e = 0; e < yn.length; e++) this.ruler2.push(yn[e][0], yn[e][1]);
	}
	skipToken(e) {
...
var Dn = {
	...
	constructor(e = {}) {
		...
		this.__opts__ = {
			...Dn,
			...n
		}, this.__schemas__ = { ...Cn }, this.re = t || new xn(), this.re.set({
			...this.__opts__,
	...
	match(e) {
		...
		for (n.lastIndex = 0, this.__opts__.fuzzyLink && this.__schemas__["http:"] && (r = this.re.get_fuzzy_link_search(), r.lastIndex = 0), this.__opts__.fuzzyEmail && this.__schemas__["mailto:"] && (i = this.re.get_fuzzy_mail_host_search(), i.lastIndex = 0, a = this.re.get_mail_name_validator());;) {
			...
			let _ = new On(e, g.schema, g.index, g.lastIndex);
	...
	matchAtStart(e) {
		...
		if (!n) return null;
		let r = new On(e, t[2], t.index + t[1].length, t.index + t[0].length + n);
...
}, J = 2147483647, Y = 36, An = 1, X = 26, jn = 38, Mn = 700, Nn = 72, Pn = 128, Fn = "-", In = /^xn--/, Ln = /[^\0-\x7F]/, Rn = /[\x2E\u3002\uFF0E\uFF61]/g, zn = {
	overflow: "Overflow: input needs wider integers to process",
	"not-basic": "Illegal input >= 0x80 (not a basic code point)",
	"invalid-input": "Invalid input"
}, Bn = 35, Z = Math.floor, Vn = String.fromCharCode;
function Q(e) {
	throw RangeError(zn[e]);
}
function Hn(e, t) {
	let n = [], r = e.length;
	for (; r--;) n[r] = t(e[r]);
...
function Un(e, t) {
	let n = e.split("@"), r = "";
	n.length > 1 && (r = n[0] + "@", e = n[1]), e = e.replace(Rn, ".");
	let i = Hn(e.split("."), t).join(".");
	return r + i;
}
function Wn(e) {
...
var Gn = (e) => String.fromCodePoint(...e), Kn = function(e) {
	return e >= 48 && e < 58 ? 26 + (e - 48) : e >= 65 && e < 91 ? e - 65 : e >= 97 && e < 123 ? e - 97 : Y;
}, qn = function(e, t) {
	return e + 22 + 75 * (e < 26) - ((t != 0) << 5);
}, Jn = function(e, t, n) {
	let r = 0;
	for (e = n ? Z(e / Mn) : e >> 1, e += Z(e / t); e > 455; r += Y) e = Z(e / Bn);
	return Z(r + 36 * e / (e + jn));
}, Yn = function(e) {
	let t = [], n = e.length, r = 0, i = Pn, a = Nn, o = e.lastIndexOf(Fn);
	o < 0 && (o = 0);
	...
	for (let s = o > 0 ? o + 1 : 0; s < n;) {
		...
		for (let t = 1, i = Y;; i += Y) {
			s >= n && Q("invalid-input");
			let o = Kn(e.charCodeAt(s++));
			o >= Y && Q("invalid-input"), o > Z((J - r) / t) && Q("overflow"), r += o * t;
			let c = i <= a ? An : i >= a + X ? X : i - a;
			if (o < c) break;
			let l = Y - c;
			t > Z(J / l) && Q("overflow"), t *= l;
		}
		let c = t.length + 1;
		a = Jn(r - o, c, o == 0), Z(r / c) > J - i && Q("overflow"), i += Z(r / c), r %= c, t.splice(r++, 0, i);
	}
	return String.fromCodePoint(...t);
}, Xn = function(e) {
	let t = [];
	e = Wn(e);
	let n = e.length, r = Pn, i = 0, a = Nn;
	for (let n of e) n < 128 && t.push(Vn(n));
	let o = t.length, s = o;
	for (o && t.push(Fn); s < n;) {
		let n = J;
		...
		for (let n of e) if (n < r && ++i > J && Q("overflow"), n === r) {
			let e = i;
			for (let n = Y;; n += Y) {
				let r = n <= a ? An : n >= a + X ? X : n - a;
				if (e < r) break;
				let i = e - r, o = Y - r;
				t.push(Vn(qn(r + i % o, 0))), e = Z(i / o);
			}
			t.push(Vn(qn(e, 0))), a = Jn(i, c, s === o), i = 0, ++s;
		}
		++i, ++r;
	}
	return t.join("");
	...
	toASCII: function(e) {
		return Un(e, function(e) {
			return Ln.test(e) ? "xn--" + Xn(e) : e;
		});
	},
	toUnicode: function(e) {
		return Un(e, function(e) {
			return In.test(e) ? Yn(e.slice(4).toLowerCase()) : e;
		});
	}
}, Qn = {
	default: {
...
}, $n = /^(vbscript|javascript|file|data):/, er = /^data:image\/(gif|png|jpeg|webp);/, tr = [
	"http:",
	"https:",
	"mailto:"
], $ = class {
	validateLink(e) {
		...
		return !$n.test(t) || er.test(t);
	}
	normalizeLink(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || tr.indexOf(t.protocol) >= 0)) try {
			t.hostname = Zn.toASCII(t.hostname);
		} catch (e) {}
		return s(c(t));
	}
	normalizeLinkText(e) {
		let t = b(e, !0);
		if (t.hostname && (!t.protocol || tr.indexOf(t.protocol) >= 0)) try {
			t.hostname = Zn.toUnicode(t.hostname);
		} catch (e) {}
		return i(c(t), i.defaultChars + "%");
	}
	constructor(...e) {
		T(this, "inline", new bn()), T(this, "block", new Bt()), T(this, "core", new _t()), T(this, "renderer", new We()), T(this, "linkify", new kn()), T(this, "utils", Se), T(this, "helpers", Object.assign({}, Ue));
		let [t, n] = e;
	...
	configure(e) {
		...
		if (typeof e == "string") {
			let n = e;
			if (t = Qn[n], !t) throw Error(`Wrong 'markdown-it' preset "${n}", check name`);
		} else t = e;
...
T($, "Token", R), T($, "Ruler", z), T($, "Renderer", We), T($, "ParserCore", _t), T($, "StateCore", Ge), T($, "ParserBlock", Bt), T($, "StateBlock", vt), T($, "ParserInline", bn), T($, "StateInline", Vt);
//#endregion
//#region src/index.ts
var nr = Ce($);
//#endregion
